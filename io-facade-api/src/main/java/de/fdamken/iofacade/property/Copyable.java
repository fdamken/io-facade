...
/**
 * Marks a path as copyable.
 *
 */
public interface Copyable {
    /**
     * Copies this path to the given destination.
     *
     * @param destination
     *            The path to copy this path to.
     * @param overwrite
     ...
     *             overwritten.
     */
    void copy(final Path destination, final boolean overwrite) throws IOException, FileAlreadyExistsException;
